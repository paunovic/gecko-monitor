...
type
  ...
  private
    ...
    procedure SetMessageNo(value : DWORD);
  ...
  published
    property MessageNo : DWORD read fMessageNo write SetMessageNo default WM_USER;
...
procedure TSHChangeNotify.SetMessageNo(value : DWORD);
begin
   if (value >= WM_USER)
